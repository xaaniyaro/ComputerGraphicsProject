...
void display(void)
{
   ...
   glBegin(GL_QUADS);
       glTexCoord2f(0.2, 0.2); glVertex3f(-2.0, -1.0, 0.0);
       glTexCoord2f(0.2, 0.8); glVertex3f(-2.0, 1.0, 0.0);
       glTexCoord2f(0.8, 0.8); glVertex3f(0.0, 1.0, 0.0);
       glTexCoord2f(0.8, 0.2); glVertex3f(0.0, -1.0, 0.0);
